import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent as defineComponent$1, computed, isRef, toRef, toRefs, TransitionGroup, Transition, mergeProps, h, shallowRef, getCurrentInstance as getCurrentInstance$1, provide, cloneVNode, createElementBlock, watch, onScopeDispose, reactive, inject as inject$1, useId, resolveDynamicComponent, warn as warn$1, toValue, createElementVNode, Fragment, normalizeClass, createVNode, camelize, isVNode as isVNode$1, Comment, ref, hasInjectionContext, toRaw, unref, readonly, watchEffect, effectScope, capitalize as capitalize$1, normalizeStyle, nextTick, defineAsyncComponent, shallowReactive, Suspense, Text, withDirectives, toDisplayString as toDisplayString$1, Teleport, vShow, createApp, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, withCtx, getCurrentScope, createBlock, openBlock, createTextVNode, useSSRContext } from 'vue';
import { w as withQuery, x as hasProtocol, y as isScriptProtocol, z as joinURL, t as destr, A as klona, B as sanitizeStatusCode, C as parse$1, D as getRequestHeader, E as isEqual$1, F as getContext, G as setCookie, H as getCookie, I as deleteCookie, $ as $fetch$1, J as baseURL, K as createHooks, L as executeAsync, r as createError$1, M as toRouteMatcher, N as createRouter$1, O as defu, P as getRequestURL, Q as createDefu, R as withoutTrailingSlash, S as parsePath, T as parseQuery, U as isEqual$2 } from '../_/nitro.mjs';
...
var Draggable = /*#__PURE__*/function (_EventDispatcher) {
  ...
  function Draggable(target, vars) {
    ...
    syncXY = function syncXY(skipOnUpdate, skipSnap) {
      ...
      gsCache.uncache && gsap$4.getProperty(target, "x"); // trigger a re-cache
      ...
      if (type !== "soft") {
        ...
        while (--i > -1) {
          ...
          if (trigger.getBBox && trigger.ownerSVGElement && allowX !== allowY) {
            ...
            gsap$4.set(trigger.ownerSVGElement, {
    ...
    _context$3(_assertThisInitialized$1(_this2));
...
toArray$3 = function toArray(value, scope, leaveStrings) {
  ...
  return function (v) {
    ...
    return toArray$3(v, el.querySelectorAll ? el : el === value ? _warn("Invalid scope") || _doc$3.createElement("div") : value);
  };
},
...
var Tween = /*#__PURE__*/function (_Animation2) {
  ...
  function Tween(targets, vars, position, skipInherit) {
    ...
    var _this3$vars = _this3.vars,
        ...
        parsedTargets = (_isArray(targets) || _isTypedArray(targets) ? _isNumber$1(targets[0]) : "length" in vars) ? [targets] : toArray$3(targets),
        tl,
        i,
        copy,
        l,
...
const _routes = [
  {
    name: "index___ar",
    path: "/",
    component: () => import('./index-C4HDqeWl.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "gallery___ar",
    path: "/gallery",
    component: () => import('./gallery-CrpuVqpi.mjs')
  },
  {
    name: "gallery___en",
    path: "/en/gallery",
  ...
  },
  {
    name: "museums___ar",
    path: "/museums",
    component: () => import('./museums-OJjGlncU.mjs')
  },
  {
    name: "museums___en",
    path: "/en/museums",
  ...
  },
  {
    name: "favorites___ar",
    path: "/favorites",
    component: () => import('./favorites-BBbpWGW8.mjs')
  },
  {
    name: "favorites___en",
    path: "/en/favorites",
  ...
  {
    name: "artifacts-3d___ar",
    path: "/artifacts-3d",
    component: () => import('./artifacts-3d-CxA4dN6-.mjs')
  },
  {
    name: "artifacts-3d___en",
    path: "/en/artifacts-3d",
    component: () => import('./artifacts-3d-CxA4dN6-.mjs')
  },
  {
    name: "relics-temples___ar",
    path: "/relics/temples",
    component: () => import('./temples-C2T-mR8j.mjs')
  },
  {
    name: "relics-temples___en",
    path: "/en/relics/temples",
    component: () => import('./temples-C2T-mR8j.mjs')
  },
  {
    name: "relics-royal-tombs___ar",
    path: "/relics/royal-tombs",
    component: () => import('./royal-tombs-uN2W9C47.mjs')
  },
  {
    name: "relics-royal-tombs___en",
    path: "/en/relics/royal-tombs",
    component: () => import('./royal-tombs-uN2W9C47.mjs')
  },
  {
    name: "collections-timeline___ar",
    path: "/collections/timeline",
    component: () => import('./timeline-Y-u0ZYrg.mjs')
  },
  {
    name: "collections-timeline___en",
    path: "/en/collections/timeline",
    component: () => import('./timeline-Y-u0ZYrg.mjs')
  },
  {
    name: "collections-hieroglyphic___ar",
    path: "/collections/hieroglyphic",
    component: () => import('./hieroglyphic-BycfE0ru.mjs')
  },
  {
    name: "collections-hieroglyphic___en",
    path: "/en/collections/hieroglyphic",
    component: () => import('./hieroglyphic-BycfE0ru.mjs')
  }
];
...
const LazyAppFooter = defineAsyncComponent(() => import('./AppFooter-CQXf8LHU.mjs').then((r) => r["default"] || r.default || r));
const LazyAppNav = defineAsyncComponent(() => import('./AppNav-DuP9Yheb.mjs').then((r) => r["default"] || r.default || r));
...
gsapWithCSS.registerPlugin(ScrollTrigger, ScrollToPlugin, Draggable, TextPlugin);
  ...
  ar: [
    {
      ...
      load: () => import(
        './ar-Bp1x0E-C.mjs'
        /* webpackChunkName: "locale_ar_46json_dd3abae4" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-oCVklkGG.mjs'
        /* webpackChunkName: "locale_en_46json_3a0a436d" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/31Oy-Fek"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/31Oy-Fek"}/${locale}/messages.json`));
...
function updateRecursionCache(a, b, cache2, result) {
  if (!cache2 || isPrimitive(a) || isPrimitive(b)) return;
  const visitedObject = cache2.get(a);
  if (visitedObject) {
    visitedObject.set(b, result);
  } else {
    const newCacheItem = /* @__PURE__ */ new WeakMap();
    newCacheItem.set(b, result);
    cache2.set(a, newCacheItem);
  }
}
function findCachedComparison(a, b, cache2) {
  if (!cache2 || isPrimitive(a) || isPrimitive(b)) return null;
  const r1 = cache2.get(a)?.get(b);
  if (typeof r1 === "boolean") return r1;
  const r2 = cache2.get(b)?.get(a);
...
const vuetify_kGSS8SRfCvms56HDNssxcWN5InhAo6_uNWFipIxsGos = /* @__PURE__ */ defineNuxtPlugin((app) => {
...
const plugins = [
  ...
  vuetify_kGSS8SRfCvms56HDNssxcWN5InhAo6_uNWFipIxsGos,
  ssg_detect_IpHCGcQQ_IR5Rl99qyukWoMA9fJGfuTYyoksTzy81cs
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-CIdFnA0O.mjs').then((m) => m.default || m))
};
...
let useFavoritesStore = defineStore("favorites", {
  state: () => ({
    favorites: []
  }),
  getters: {
    ...
    useRender(() => {
      ...
      return withDirectives(createVNode(Tag, mergeProps(link.linkProps, {
        ...
        default: () => [genOverlays(true, "v-btn"), !props.icon && hasPrepend && createElementVNode("span", {
          ...
          default: () => [slots.default?.() ?? toDisplayString$1(props.text)]
...
function connectedLocationStrategy(data, props, contentStyles) {
  ...
  watch(data.target, (newTarget, oldTarget) => {
    if (oldTarget && !Array.isArray(oldTarget)) observer2.unobserve(oldTarget);
    if (!Array.isArray(newTarget)) {
      if (newTarget) observer2.observe(newTarget);
  ...
  watch(data.contentEl, (newContentEl, oldContentEl) => {
    if (oldContentEl) observer2.unobserve(oldContentEl);
    if (newContentEl) observer2.observe(newContentEl);
  }, {
    immediate: true
  });
  onScopeDispose(() => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VSnackbar, {
        modelValue: unref(snackFavorite),
        "onUpdate:modelValue": ($event) => isRef(snackFavorite) ? snackFavorite.value = $event : snackFavorite = $event,
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VBtn, {
              icon: "",
              onClick: ($event) => isRef(snackFavorite) ? snackFavorite.value = false : snackFavorite = false
            }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(favorites).isFavorite(unref(item).id)) {
              _push2(`<p class="sm:text-lg"${_scopeId}>${ssrInterpolate(_ctx.$t(unref(item).name))} ${ssrInterpolate(_ctx.$t("all.favorites.added"))}</p>`);
            } else {
              _push2(`<p class="sm:text-lg"${_scopeId}>${ssrInterpolate(_ctx.$t(unref(item).name))} ${ssrInterpolate(_ctx.$t("all.favorites.removed"))}</p>`);
            }
          } else {
            return [
              unref(favorites).isFavorite(unref(item).id) ? (openBlock(), createBlock("p", {
                key: 0,
                class: "sm:text-lg"
              }, toDisplayString$1(_ctx.$t(unref(item).name)) + " " + toDisplayString$1(_ctx.$t("all.favorites.added")), 1)) : (openBlock(), createBlock("p", {
                key: 1,
                class: "sm:text-lg"
              }, toDisplayString$1(_ctx.$t(unref(item).name)) + " " + toDisplayString$1(_ctx.$t("all.favorites.removed")), 1))
            ];
          }
        }),
        _: 1
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UI/SnackbarFavorites.vue");
...
function useLang() {
  ...
  function addDirectionAndLang() {
    if (useCookie("i18n_redirected").value === "ar") {
      (void 0).documentElement.setAttribute("lang", "ar");
      (void 0).documentElement.setAttribute("dir", "rtl");
    } else {
      (void 0).documentElement.setAttribute("lang", "en");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UI/DialogDetelis.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-bgmain dark:bg-[#080326] min-h-screen text-white overflow-x-hidden!" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DjUW2gLx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-g6yNni29.mjs'));
...
export { getCurrentInstanceName as $, makeSizeProps as A, makeRoundedProps as B, makeElevationProps as C, makeDensityProps as D, makeBorderProps as E, keyValues as F, useSize as G, useBackgroundColor as H, IconValue as I, useRounded as J, useElevation as K, VDefaultsProvider as L, MaybeTransition as M, convertToUnit as N, useDensity as O, pick as P, EventProp as Q, deepEqual as R, Ripple as S, filterInputAttrs as T, wrapInArray as U, VIcon as V, useTextColor as W, matchesSelector as X, omit as Y, callEvent as Z, __nuxt_component_0$1 as _, useLang as a, getCurrentInstance as a0, useToggleScope as a1, makeGroupProps as a2, makeDisplayProps as a3, useGroup as a4, useGoTo as a5, focusableChildren as a6, useBorder as a7, useGroupItem as a8, useLink as a9, useState as aA, useRouter$1 as aB, resolveRouteObject as aC, useRuntimeConfig as aD, navigateTo as aE, nuxtLinkDefaults as aF, PREFERS_REDUCED_MOTION as aG, getTargetBox as aH, acceleratedEasing as aI, deceleratedEasing as aJ, consoleError as aK, defineComponent as aL, deprecate as aM, isPrimitive as aN, focusChild as aO, VMenuSymbol as aP, isClickInsideElement as aQ, getNextElement as aR, useVariant as aa, genOverlays as ab, makeRouterProps as ac, makeGroupItemProps as ad, useLoader as ae, nullifyTransforms as af, animate as ag, standardEasing as ah, LoaderSlot as ai, makeLoaderProps as aj, forwardRefs as ak, debounce as al, clamp as am, getPropertyFromItem as an, camelizeProps as ao, ensureValidVNode as ap, checkPrintable as aq, createLayout as ar, makeLayoutProps as as, useLayout as at, useRoute$1 as au, makeLayoutItemProps as av, useLayoutItem as aw, useScopeId as ax, VOverlay as ay, makeVOverlayProps as az, useI18n as b, VBtn as c, useRtl as d, entry_default as default, useDimension as e, useRender as f, genericComponent as g, makeDimensionProps as h, makeComponentProps as i, VBtnToggle as j, breakpoints as k, useNuxtApp as l, makeTagProps as m, useProxiedModel as n, makeTransitionProps as o, propsFactory as p, useFavoritesStore as q, useLocale as r, provideTheme as s, useDisplay as t, useHead as u, provideDefaults as v, useResizeObserver as w, createRange as x, makeVariantProps as y, makeThemeProps as z };
