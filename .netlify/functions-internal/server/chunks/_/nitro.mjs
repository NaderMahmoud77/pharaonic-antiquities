...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "95603128-6fa1-4ce3-b59f-5c031a51279a",
...
const localeLoaders = {
  ar: [
    {
      key: "locale_ar_46json_dd3abae4",
      load: () => import('./ar.mjs' /* webpackChunkName: "locale_ar_46json_dd3abae4" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_3a0a436d",
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_3a0a436d" */),
      cache: true
    }
  ]
};
...
const pathToI18nConfig = {
  ...
  "/relics/royal-tombs": {
    "ar": "/relics/royal-tombs",
    "en": "/relics/royal-tombs"
  },
  "/collections/timeline": {
    "ar": "/collections/timeline",
    "en": "/collections/timeline"
  },
  "/collections/hieroglyphic": {
    "ar": "/collections/hieroglyphic",
    "en": "/collections/hieroglyphic"
  }
};
const i18nPathToPath = {
  ...
  "/museums": "/museums",
  "/favorites": "/favorites",
  "/artifacts-3d": "/artifacts-3d",
  "/relics/temples": "/relics/temples",
  "/relics/royal-tombs": "/relics/royal-tombs",
  "/collections/timeline": "/collections/timeline",
  "/collections/hieroglyphic": "/collections/hieroglyphic"
};
...
const _NKAcOJEuyLmTuAV5bP4_oIuxwWAU5r4Csc7BlUCnGKM = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/31Oy-Fek") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _NKAcOJEuyLmTuAV5bP4_oIuxwWAU5r4Csc7BlUCnGKM
];
...
const _72neYO = _messagesHandlerCached;

const _lazy_8TZyDt = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_8TZyDt, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _72neYO, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8TZyDt, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, klona as A, sanitizeStatusCode as B, parse as C, getRequestHeader as D, isEqual as E, getContext as F, setCookie as G, getCookie as H, deleteCookie as I, baseURL as J, createHooks as K, executeAsync as L, toRouteMatcher as M, createRouter$1 as N, defu as O, getRequestURL as P, createDefu as Q, withoutTrailingSlash as R, parsePath as S, parseQuery as T, isEqual$1 as U, withTrailingSlash as V, appRootTag as a, buildAssetsURL as b, appRootAttrs as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, appId as k, defineRenderHandler as l, appTeleportTag as m, normalizeCookieHeader as n, appTeleportAttrs as o, publicAssetsURL as p, getQuery as q, createError$1 as r, appHead as s, destr as t, useNitroApp as u, getRouteRules as v, withQuery as w, hasProtocol as x, isScriptProtocol as y, joinURL as z };
